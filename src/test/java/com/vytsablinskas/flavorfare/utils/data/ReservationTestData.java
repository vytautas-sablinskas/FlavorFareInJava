...
public class ReservationTestData {
    public static AddReservationDto getAddReservationDtoA() {
        return AddReservationDto.builder()
                .startTime(LocalDateTime.of(2023, 10, 23, 10, 20, 0))
                .endTime(LocalDateTime.of(2023, 10, 23, 12, 20, 0))
    ...
    public static AddReservationDto getAddReservationDtoB() {
        return AddReservationDto.builder()
                .startTime(LocalDateTime.of(2023, 11, 24, 10, 0, 0))
                .endTime(LocalDateTime.of(2023, 11, 24, 11, 0, 0))
                .extraInformation("Near window")
                .build();
    }
    ...
    public static ReservationDto getReservationDtoA() {
        return ReservationDto.builder()
                .id(5)
                .startTime(LocalDateTime.of(2022, 11, 24, 10, 0, 0))
                .endTime(LocalDateTime.of(2022, 11, 24, 11, 0, 0))
