...
public class TableControllerIntegrationTests {
    ...
    public void getTables_validRestaurantId_returnsHttpStatus200() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.get(TableEndpoints.tables(restaurantDto.getId()))
    ...
    public void getTables_invalidRestaurantId_returnsHttpStatus404WithMessage() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.get(TableEndpoints.tables(invalidRestaurantId))
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
    ...
    public void getTable_validIds_returnsHttpStatus200() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.get(TableEndpoints.table(restaurantDto.getId(), table.getId()))
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
                MockMvcResultMatchers.status().isOk()
        );
    ...
    public void getTable_invalidRestaurantId_returnsHttpStatus404WithMessage() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.get(TableEndpoints.table(invalidRestaurantId, shouldNotReachTableId))
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
                MockMvcResultMatchers.status().isNotFound()
        ).andExpect(
    ...
    public void getTable_invalidTableId_returnsHttpStatus404WithMessage() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.get(TableEndpoints.table(restaurantDto.getId(), invalidTableId))
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
                MockMvcResultMatchers.status().isNotFound()
        ).andExpect(
